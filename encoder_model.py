...
from transformers import AutoModel, RobertaModel, RobertaPreTrainedModel
...
class BertEncoder(RobertaPreTrainedModel):
    def __init__(self, model_name, model_config):
        super(BertEncoder, self).__init__(model_config)
        self.encoder = RobertaModel.from_pretrained(model_name, config=model_config)
