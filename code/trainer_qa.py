...
from transformers import Trainer, Seq2SeqTrainer, is_datasets_available, is_torch_tpu_available
...
class GenerationBasedModel(Seq2SeqTrainer):
    def __init__(self, *args, eval_examples=None, preprocess_function=None, post_process_function=None, **kwargs):
        super().__init__(*args, **kwargs)
        self.eval_examples = eval_examples
